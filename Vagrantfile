Vagrant.configure("2") do |config|
    config.vm.define "vm1" do |vm1|
        ...
        " VM is up!
        Execute: sudo iptables -t nat -A OUTPUT -p tcp -d 127.0.0.1 --dport 80 -j REDIRECT --to-ports 8080
        Execute: sudo iptables -t nat -A OUTPUT -p tcp -d 127.0.0.1 --dport 443 -j REDIRECT --to-ports 4443
        "
        MSG
    end
end